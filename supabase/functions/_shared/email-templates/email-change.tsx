...
export const EmailChangeEmail = ({
  ...
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Confirma el cambio de correo en EasyConnect OSH</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Solicitaste cambiar tu correo electrónico en EasyConnect OSH de{' '}
        ...
        <Text style={text}>
          Haz clic en el botón a continuación para confirmar este cambio:
        </Text>
