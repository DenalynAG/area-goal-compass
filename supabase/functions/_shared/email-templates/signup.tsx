...
export const SignupEmail = ({ siteName, siteUrl, recipient, confirmationUrl }: SignupEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Confirma tu correo para OSH HOTELS</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img
          ...
          style={logo}
        />
        <Heading style={h1}>¡Bienvenidos!</Heading>
        <Text style={text}>
          Gracias por registrarte en{" "}
          <Link href={siteUrl} style={link}>
            <strong>OSH HOTELS </strong>
          </Link>
        ...
        <Text style={footer}>Si no creaste una cuenta, puedes ignorar este correo con seguridad.</Text>
      </Container>
    </Body>
  </Html>
);
